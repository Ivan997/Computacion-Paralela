...
public class Mercurio extends Planetas{
	...
	int paso=7,pasobandera=7;
	public Mercurio(JFrame marco, JPanel panel) {
		this.marco = marco;
		this.panel = panel;
		this.setValores(30, 30, 10, 0,90);
		this.cuerpoCeleste= new ImageIcon("./mercurio.png");
	}
	public Mercurio(JFrame marco, JPanel panel, double rotacion) {
		this.marco = marco;
		this.panel = panel;
		this.setValores(30, 30, 10, 0,90);
		this.cuerpoCeleste= new ImageIcon("./mercurio.png");
	...
	public void pintar() {
		...
		posCuerpoCelestex= (int) (ancho/2 - anchoCuerpoCeleste-40-separacionx);
