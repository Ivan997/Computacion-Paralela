...
public class Marte extends Planetas{
	...
	public Marte(JFrame marco, JPanel panel) {
		this.marco = marco;
		this.panel = panel;
		this.setValores(35, 35, 60, 0, 370);//Ancho del planeta, alto del planeta, separacionx, separaciony,tamaniosAnteriores
		this.cuerpoCeleste= new ImageIcon("./marte.png");
	}
	public Marte(JFrame marco, JPanel panel, double rotacion) {
		this.marco = marco;
		this.panel = panel;
		this.setValores(35, 35, 60, 0, 370);//Ancho del planeta, alto del planeta, separacionx, separaciony,tamaniosAnteriores
		this.cuerpoCeleste= new ImageIcon("./marte.png");
