...
public class Jupiter extends Planetas{
	...
	int paso=1, pasobandera=1;
	public Jupiter(JFrame marco, JPanel panel) {
		this.marco = marco;
		this.panel = panel;
		this.setValores(60, 60, 60, 0, 500);//Ancho del planeta, alto del planeta, separacionx, separaciony,tamaniosAnteriores
		this.cuerpoCeleste= new ImageIcon("./jupiter.png");
		this.rotacion=0.8;
	}
	public Jupiter(JFrame marco, JPanel panel, double rotacion) {
		this.marco = marco;
		this.panel = panel;
		this.setValores(60, 60, 60, 0, 500);//Ancho del planeta, alto del planeta, separacionx, separaciony,tamaniosAnteriores
		this.cuerpoCeleste= new ImageIcon("./jupiter.png");
