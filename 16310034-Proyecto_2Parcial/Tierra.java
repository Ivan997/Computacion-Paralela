...
public class Tierra extends Planetas{
	...
	public int paso=4,pasobandera=4, vueltas=0;
	public Tierra(JFrame marco, JPanel panel) {
		this.marco = marco;
		this.panel = panel;
		this.setValores(40, 40, 60, 0, 270);//Ancho del planeta, alto del planeta, separacionx, separaciony,tamaniosAnteriores
		this.cuerpoCeleste= new ImageIcon("./tierra.png");
	}
	public Tierra(JFrame marco, JPanel panel, double rotacion) {
		this.marco = marco;
		this.panel = panel;
		this.setValores(40, 40, 60, 0, 270);//Ancho del planeta, alto del planeta, separacionx, separaciony,tamaniosAnteriores
		this.cuerpoCeleste= new ImageIcon("./tierra.png");
